...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        LineReaderIterator reader = null;
        try {
            reader = new LineReaderIterator();
        } catch (IOException e) {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "An IO error occurred during CSV file processing: " + e.getMessage());
        } finally {
            for (Handler handler : logger.getHandlers()) {
                handler.close();
            }
            if (reader != null) {
                try {
                    ...
                    logger.log(Level.WARNING, "Failed to close the reader: " + e.getMessage());
                }
            }
        }
    }
